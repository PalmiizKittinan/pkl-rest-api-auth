            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">
                            <?php esc_html_e( 'When enabled, all requests to /wp-json/wp/v2/pages and its sub-endpoints will not require authentication.', 'pkl-rest-api-auth' ); ?>
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">
                            <?php esc_html_e( 'When enabled, all requests to /wp-json/wp/v2/posts and its sub-endpoints will not require authentication.', 'pkl-rest-api-auth' ); ?>
                        </p>
                    </td>
                </tr>
            </table>
