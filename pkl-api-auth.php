...
define( 'PKL_REST_API_AUTH_VERSION', '2.4.0' );
...
class PKL_REST_API_Auth {
	...
	public function restrict_rest_api( $result ) {
		...
		$allow_root  = get_option( 'pkl_rest_api_auth_allow_root_endpoint', 0 );
		$allow_pages = get_option( 'pkl_rest_api_auth_allow_pages', 0 );
		$allow_posts = get_option( 'pkl_rest_api_auth_allow_posts', 0 );
